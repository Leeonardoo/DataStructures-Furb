...
public class ListaEstaticaGenericaKtTests {

    private ListaEstaticaGenericaKt<Integer> testList;

    @BeforeEach
    void setup() {
        testList = new ListaEstaticaGenericaKt<>();
    }
    ...
    @Test
    @DisplayName("obterElemento() should return the element")
    void getElement() {
        testList.inserir(5);
        testList.inserir(10);
        testList.inserir(15);
